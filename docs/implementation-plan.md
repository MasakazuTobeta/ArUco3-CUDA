...
- patent clearance ([R7](#リスクと対策))。2026-08-29 に着手し、手順 1 と 3 を実施しました ([特許 Clearance 下調べ記録](patent-clearance.md))。同日、**販売予定国を日本と米国へ決定**し、手順 2 の範囲が定まりました。実施担当は未定です。
...
| R7 | patent clearance が未実施のまま商用検討が進む | 事業判断の遅延 | [知的財産・ライセンス方針](ip-and-licensing.md) の手順を Phase 4 完了までに開始する。**2026-08-29 に着手した。** 手順 1 と 3 を実施、手順 2 は米国のみ一部。記録は [特許 Clearance 下調べ記録](patent-clearance.md)。**2026-08-29 に販売予定国を日本と米国へ決定した**ため手順 2 の範囲が定まった。残件は日本国内の調査と実施担当の決定 |
