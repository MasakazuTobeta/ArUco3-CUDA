...
# The samples and the Python package are built by default only when this project
# is the top-level one. Someone pulling the library in with add_subdirectory
# wants the library, not extra executables and a staged Python tree. Someone
# working in the repository wants them built on every build, because a sample
# that is never built is a sample that has already stopped compiling.
if(PROJECT_IS_TOP_LEVEL)
  set(kTopLevelDefault ON)
else()
  set(kTopLevelDefault OFF)
endif()
option(ARUCO3CUDA_BUILD_EXAMPLES "Build the sample programs under examples/" ${kTopLevelDefault})
option(ARUCO3CUDA_BUILD_PYTHON "Stage the ctypes Python package under python/" ${kTopLevelDefault})
